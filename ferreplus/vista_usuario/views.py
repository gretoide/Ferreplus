...
def pagina_principal(request):
    ...
    return render(request, 'vista_usuario/vista_principal.html', {'publicaciones': publicaciones, 'primeras_imagenes_por_publicacion': primeras_imagenes_por_publicacion})
